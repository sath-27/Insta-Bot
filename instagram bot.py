...
def follow_like_comment(number):
    profiles_list=['mahi7781', 'sureshrain3']
    comments=['whistle podu', 'biggest fan', 'i like your bike collection', 'visit vizag once', 'one movie of you both', 'looks very special']
